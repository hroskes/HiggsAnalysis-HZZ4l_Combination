...
class properties_datacardClass:
    ...
    def makeCardsWorkspaces(self, theMH, theOutputDir, theInputs,theTemplateDir="templates2D",bincludeInter=1):
        ...
        self.includeInter= bincludeInter 
        print "include interf ", self.includeInter 
