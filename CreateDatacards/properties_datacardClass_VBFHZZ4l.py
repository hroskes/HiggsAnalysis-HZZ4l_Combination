	...
	# n, alpha are left side parameters of DoubleCB
        ...
        for p in "qqH", "ZH", "WH":
            ...
            for i, t in enumerate(T[p], start=1):
                t.SetName("{}_T_ZZ_{}_{}_3D_{}".format(p, self.production.year,self.appendName, i))
            ...
            for i, t in enumerate(T_ScaleResUp[p], start=1):
                t.SetName("{}_T_ZZ_{}_{}_3D_{}_ScaleResUp".format(p, self.production.year,self.appendName, i))
            ...
            for i, t in enumerate(T_ScaleResDown[p], start=1):
                t.SetName("{}_T_ZZ_{}_{}_3D_{}_ScaleResDown".format(p, self.production.year,self.appendName, i))

            T_integralName = ["{}_normt{}_{}_{}".format(p, i, self.channel,self.production.year) for i in range(1, 6)]
            ...
            pdfName_syst1Up = "{}_ScaleRes{}Up".format(p, self.appendName)
            pdfName_syst1Down = "{}_ScaleRes{}Down".format(p, self.appendName)
        ...
        for i, t in enumerate(T["ggH"], start=1):
            t.SetName("ggH_T_ZZ_{}_{}_3D_{}".format(self.production.year,self.appendName, i))
        ...
        for i, t in enumerate(T_ScaleResUp["ggH"], start=1):
            t.SetName("ggH_T_ZZ_{}_{}_3D_{}_ScaleResUp".format(self.production.year,self.appendName, i))
        ...
        for i, t in enumerate(T_ScaleResDown["ggH"], start=1):
            t.SetName("ggH_T_ZZ_{}_{}_3D_{}_ScaleResDown".format(self.production.year,self.appendName, i))

        T_integralName = ["ggH_normt{}_{}_{}".format(i, self.channel,self.production.year) for i in range(1, 4)]
        ...
        pdfName_syst1Up = "ggH_ScaleRes{}Up".format(self.appendName)
        pdfName_syst1Down = "ggH_ScaleRes{}Down".format(self.appendName)
